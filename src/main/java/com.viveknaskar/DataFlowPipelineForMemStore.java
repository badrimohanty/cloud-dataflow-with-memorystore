...
public class DataFlowPipelineForMemStore {
    public static interface StorageToRedisOptions extends PipelineOptions {
        ...
        /**
         * Memorystore/Redis instance host. Update with a running memorystore instance in the
         command-line to execute the pipeline
         */
...
/**
 * Constructed StorageToRedisOptions object using the method
 PipelineOptionsFactory.fromArgs to read options from command-line
 */
        ...
        p.apply("Reading Lines...", TextIO.read().from(options.getInputFile()))
                ...
                .apply("Processing data...",
                        ParDo.of(new DoFn<String[], KV<String, String>>() {
                            @ProcessElement
                            public void ProcessData(@Element String[] fields, OutputReceiver<KV<String,
